...
function the_posts_navigation() {
	...
	<nav class="navigation posts-navigation" role="navigation">
		<h2 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', '_sSs' ); ?></h2>
		<div class="nav-links">

			<?php if ( get_next_posts_link() ) : ?>
			<div class="nav-previous"><?php next_posts_link( esc_html__( 'Older posts', '_sSs' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( esc_html__( 'Newer posts', '_sSs' ) ); ?></div>
			<?php endif; ?>
...
function the_post_navigation() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h2 class="screen-reader-text"><?php esc_html_e( 'Post navigation', '_sSs' ); ?></h2>
		<div class="nav-links">
			<?php
...
function _sSs_entry_footer() {
	...
	if ( 'post' == get_post_type() ) {
		...
		if ( $categories_list && _sSs_categorized_blog() ) {
 ...
 * @return bool
 */
function _sSs_categorized_blog() {
	...
	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so _sSs_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so _sSs_categorized_blog should return false.
		return false;
	}
}
